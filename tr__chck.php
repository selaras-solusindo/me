...
//$mnamadb__ = "db_me"; // untuk localhost
$mnamadb__ = "andalanm_me"; // untuk hosting
...
$mnamatb__ = "tb_" . $_POST["thn_evnt"] . $_POST["bln_evnt"];
...
// save session periode yang diproses
// session digunakan untuk menampilkan data pada combo pada menu.php
$_SESSION["blthevnt"] = $_POST["bln_evnt"] . $_POST["thn_evnt"];
